...
- {id: LPSPI4_CLK_ROOT.outFreq, value: 40 MHz, locked: true, accuracy: '0.001'}
...
- {id: CCM.CLOCK_ROOT46.DIV.scale, value: '10', locked: true}
- {id: CCM.CLOCK_ROOT46.MUX.sel, value: ANADIG_OSC.OSC_RC_400M}
...
void BOARD_BootClockRUN(void)
{
    ...
    */
    ...
    /* Configure LPSPI4 using OSC_RC_400M */
    rootCfg.mux = kCLOCK_LPSPI4_ClockRoot_MuxOscRc400M;
    rootCfg.div = 10;
